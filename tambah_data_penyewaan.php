<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        print_r($idSubKategoriRetribusi);
...
";
    ...
    $listPemungut = $class->getListofPemungut();
    ?>
                ...
                <form method="POST" action="?url=tambah_data_penyewaan">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input required type="text" class="form-control" id="detail_volume" name="detail_volume" placeholder="/kegiatan, jam/hari, dll...">
                        </div>
                        <div class="form-group col-md-3">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="penyetor" id="penyetor" class="form-control" required>
                                <option value="" selected disabled>-- Pilih Nama Penyetor --</option>
                                <?php foreach ($listPemungut as $data) {
                                ?>
                                    <option value="<?= $data['id_pemungut'] ?>"><?= $data['nama_pemungut'] ?></option>
                                <?php
                                } ?>
                            </select>
                        </div>
